/*!
 * react-auto-form v2.0.0 - https://github.com/insin/react-auto-form
 * MIT Licensed
 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_get_form_data__ = __webpack_require__(6);
...
var AutoForm = (_temp2 = _class = function (_React$Component) {
  ...
  function AutoForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this._onChange = function (e) {
      ...
      var data = Object(__WEBPACK_IMPORTED_MODULE_0_get_form_data__["getNamedFormElementData"])(form, name, { trim: _this.props.trim });
      var change = {};
      change[name] = data;
      _this.props.onChange(e, name, data, change);
    }, _this._onSubmit = function (e) {
      var data = __WEBPACK_IMPORTED_MODULE_0_get_form_data___default()(e.target, { trim: _this.props.trimOnSubmit || _this.props.trim });
  ...
  trim: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  trimOnSubmit: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool
}, _class.defaultProps = {
  component: 'form',
  trim: false,
  trimOnSubmit: false
